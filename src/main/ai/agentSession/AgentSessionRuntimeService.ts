...
export class AgentSessionRuntimeService extends BaseService {
   ...
   * detached runtime-terminal recoveries and flow finalizers, bounded by timeoutMs. Never rejects;
   * stragglers are NOT aborted. The resulting stream writes are AiStreamManager's drain — this only
   * covers the windows this service writes in.
